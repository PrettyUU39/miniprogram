    ...
    return (
        function (Module) {
            ...
            if (ENVIRONMENT_IS_NODE) {
                ...
                if (ENVIRONMENT_IS_WORKER && iswechat == false) {
            ...
            var wasmBinaryFile;
            wasmBinaryFile = "web_tracking_wasm.wasm";
            ...
            function createWasm() {
                ...
                function instantiateArrayBuffer(receiver) {
                    if (iswechat === true) {
                        var result = WXWebAssembly.instantiate('/pages/index/web_tracking_wasm.wasm', info);
                        return result.then(receiveInstantiationResult)
                    }
                }

                function instantiateAsync() {
                    if (!wasmBinary && typeof WXWebAssembly.instantiateStreaming === "function" && !isDataURI(wasmBinaryFile) && !isFileURI(wasmBinaryFile) && typeof fetch === "function") {
                        return fetch(wasmBinaryFile, {
                            credentials: "same-origin"
                        }).then(function (response) {
            ...
            var ___embind_register_native_and_builtin_types = Module["___embind_register_native_and_builtin_types"] = function () {
                return (___embind_register_native_and_builtin_types = Module["___embind_register_native_and_builtin_types"] = Module["asm"]["_"]).apply(null, arguments)
            };
            var __get_tzname = Module["__get_tzname"] = function () {
                return (__get_tzname = Module["__get_tzname"] = Module["asm"]["$"]).apply(null, arguments)
            };
            ...
            var dynCall_viijii = Module["dynCall_viijii"] = function () {
                return (dynCall_viijii = Module["dynCall_viijii"] = Module["asm"]["ca"]).apply(null, arguments)
            };
            var dynCall_iijjiiii = Module["dynCall_iijjiiii"] = function () {
                return (dynCall_iijjiiii = Module["dynCall_iijjiiii"] = Module["asm"]["da"]).apply(null, arguments)
            };
