...
// Attempt to auto-detect the environment4
const iswechat = true
...
function abort(what) {
  ...
  // defintion for WXWebAssembly.RuntimeError claims it takes no arguments even
  // though it can.
...
function createWasm() {
  ...
  function instantiateArrayBuffer(receiver) {
    if(iswechat === true){
        var result = WXWebAssembly.instantiate('/pages/index/testclass.wasm',info)
  ...
  function __embind_register_float(rawType, name, size) {
      ...
      registerType(rawType, {
          ...
          'toWireType': function(destructors, value) {
              ...
              // https://www.w3.org/TR/wasm-js-api-1/#toWXWebAssemblyvalue
              return value;
          },
          'argPackAdvance': 8,
